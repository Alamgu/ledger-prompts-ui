...
pub const DASHBOARD_GLYPH: Glyph = Glyph::from_include(include_gif!("icons/dashboard.gif"));
pub const SETTINGS_GLYPH: Glyph = Glyph::from_include(include_gif!("icons/settings.gif"));
